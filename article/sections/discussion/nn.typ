...
This did not stop others in the field from attempting to replace 
noise-based terrain with something more aesthetic and novel,
see @sec:future_noise_diffusion.
