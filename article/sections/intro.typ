...
_#[@MC]_ #footnote[https://www.minecraft.net] or 
...
we can exploit various tricks to lighten the burden 
on both developers and hardware.
These techniques usually fall under the term @LOD, 
explained by @sec:concept_lod. 
...
let alone choosing where to land their ship while not 
crashing into mountains at high speeds.
...
=== Community
Around the _#[@MC]_ scene, recent technical achievements regarding @LOD 
